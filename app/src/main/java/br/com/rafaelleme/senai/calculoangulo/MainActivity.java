...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtValorAngulo = findViewById(R.id.adtValorAngulo);
    ...
    private boolean validar() {
        if (edtValorAngulo.getText().toString().equals("")) {
            ...
            double valorÂngulo = Double.valueOf(edtValorAngulo.getText().toString());
            if(valorÂngulo >= 0 && valorÂngulo <= 360){
                return true;
            }else{
                edtValorAngulo.setError("O valor deve estar entre o e 360");
                return false;
            }
        }
    }
